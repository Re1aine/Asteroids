...
namespace Code.Logic.Gameplay.Services.GameFactory
{
    public class GameFactory : IGameFactory
    {
        ...
        public Bullet.Bullet CreateBullet(Vector3 position, Quaternion rotation)
        {
            Bullet.Bullet bullet = _assetsProvider.InstantiateAt<Bullet.Bullet>(AssetPath.Bullet, position, rotation);
